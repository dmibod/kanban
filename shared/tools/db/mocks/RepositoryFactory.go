...
func (_m *RepositoryFactory) CreateRepository(_a0 string, _a1 db.RepositoryEntity) db.Repository {
	ret := _m.Called(_a0, _a1)

	var r0 db.Repository
	if rf, ok := ret.Get(0).(func(string, db.RepositoryEntity) db.Repository); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
